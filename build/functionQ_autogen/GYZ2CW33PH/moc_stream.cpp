...
QT_MOC_LITERAL(1, 7, 12), // "onStreamStop"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "Stream\0onStreamStop\0"
};
...
void Stream::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Stream::onStreamStop)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Stream::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_Stream.data,
    qt_meta_data_Stream,
    qt_static_metacall,
    nullptr,
    nullptr
